...
<div class="container-fluid p-0">
    ...
    <div class="courses d-flex mt-0 bg-light px-1 justify-content-start py-3" style="flex-wrap:wrap ;">
        ...
        <?php if ($wp_query->have_posts()) : ?>
            ...
            ?>
                <div class="card border-1 rounded-1 px-2 my-2 pb-0 download   w-100 mx-1  " data-aos="fade-up">
                    <div class="row">


                        <div class="col-md-2 py-1 px-1 col-lg-2  col-sm-12">
                            <a href="<?php the_permalink() ?>">
                                <?php the_post_thumbnail('thumbnail') ?>
                            </a>
                        </div>
                        <div class="col-md-9 col-sm-12 col-lg-9 px-1">
                            <div class="card-body">
                                <a href="<?php the_permalink() ?>">
                                ...
                                <p class="text-left pt-0">
                                    <a href="<?php the_permalink() ?>" class="text-center readmore " style="text-decoration: none; color:gray;">Readmore.. <i class='bx bx-right-arrow-alt' style='color:#fe1169'></i></a>
                                </p>
                            </div>
                        </div>
                    </div>
