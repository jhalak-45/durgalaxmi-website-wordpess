...
<div class="outer">
    <div class="container-fluid p-0">
        <div class="courses py-5 px-2 " style="flex-wrap: wrap; background-color:#f1f2f2;">
            <?php
            ...
            <?php if ($wp_query->have_posts()) : ?>
                ...
                ?>
                    ...
                    <div class="card m-1 border-0" data-bs-toggle="modal" data-bs-target="#staticBackdrop" style="width: 18rem;" data-aos="fade-up">
                        <h5 class="member-post bg-danger py-2  mb-0 text-light text-center"><?php the_field('staff_post') ?></h5>
                        <img src="<?php the_field('staff_photo') ?>" class="img-fluid mt-0" height="190px" width="100%">
